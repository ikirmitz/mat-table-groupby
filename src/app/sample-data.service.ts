...
export class SampleDataService {
  ...
  axes: Axes[] = [
    { columnDef: 'InternalJobInfo', header: 'Internal Job Info', cell: (element: any) => `${element.InternalJobInfo}`, group: true },
    { columnDef: 'Ethnicity', header: 'Ethnicity', cell: (element: any) => `${element.Ethnicity}`, group: false },
    { columnDef: 'EMEA', header: 'EMEA', cell: (element: any) => `${element.EMEA}`, group: false },
    { columnDef: 'AMEC', header: 'AMEC', cell: (element: any) => `${element.AMEC}`, group: false },
    { columnDef: 'APAC', header: 'APAC', cell: (element: any) => `${element.APAC}`, group: false },
    { columnDef: 'SWISS', header: 'SWISS', cell: (element: any) => `${element.SWISS}`, group: false }
  ]
